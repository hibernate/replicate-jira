...
class SimpleProjectHookTest {
	...
	void unknown() {
		given()
				...
				.post( "api/jira/webhooks/NOTAPROJECTKEY" )
				.then()
				.statusCode( 500 )
				.body( containsString( "Unable to determine handler context for project NOTAPROJECTKEY. Was it not configured" ) );
	}
	...
	void known() {
		given()
				...
				.body( """
						...
						""" )
				.contentType( ContentType.JSON )
				.post( "api/jira/webhooks/JIRATEST1" )
				.then()
				.statusCode( 200 )
				.body( is( "ack" ) );
	}
